<template>
  <div class="ra-page page-index">
    <main class="ra-page-main">
      <el-row :gutter="15">
        <el-col :span="16">
          <!-- 安全预警、安全防护、待办事项 -->
          <div class="index-section">
            <el-row :gutter="15">
              <el-col :span="10">
                <div class="ra-panel index-security-warning">
                  <div class="ra-panel__hd">安全预警</div>
                  <el-row :gutter="10" class="ra-panel__bd">
                    <el-col :span="8">
              ...
              <el-col :span="7">
                <div class="ra-panel index-security-protect">
                  <div class="ra-panel__hd">安全防护</div>
              ...
              <el-col :span="7">
                <div class="ra-panel index-undo">
                  <div class="ra-panel__hd">待办事项</div>
                  <div class="ra-panel__bd">
          ...
          <!-- 最近使用的产品 -->
          <div class="index-section">
            <div class="ra-panel index-recent">
              <div class="ra-panel__hd clearfix">
                <span>最近使用的产品</span>
          ...
          <!-- 我的资源、我的消费、推荐返利 -->
          <div class="index-section">
            <div class="ra-panel index-personal">
              <div class="ra-panel__bd">
                <el-tabs class="ra-tabs" v-model="indexPersonalTabsActive">
        ...
        <el-col :span="8">
          <!-- 公告 -->
          <div class="index-section">
            <div class="ra-panel index-notice">
              <div class="ra-panel__bd">
          ...
          <!-- 管理助手 -->
          <div class="index-section">
            <div class="ra-panel index-assistant">
              <div class="ra-panel__hd clearfix">
                <span>管理助手</span>
          ...
          <!-- 新产品快报 -->
          <div class="index-section">
            <div class="ra-panel index-information">
              <div class="ra-panel__hd">新产品快报</div>
              <div class="ra-panel__bd">
