    ...
    <div class="ra-west__inner">
      <el-menu
        ...
        <el-submenu index="chart" :popper-append-to-body="false">
          <template slot="title">
            <svg class="icon-svg ra-west__menu-icon" aria-hidden="true"><use xlink:href="#barchart"></use></svg>
            <span>图表</span>
          </template>
        ...
        <!-- <el-submenu index="form" :popper-append-to-body="false">
          <template slot="title">
            <svg class="icon-svg ra-west__menu-icon" aria-hidden="true"><use xlink:href="#file-text"></use></svg>
            <span>表单页面</span>
          </template>
        ...
        <el-submenu index="list" :popper-append-to-body="false">
          <template slot="title">
            <svg class="icon-svg ra-west__menu-icon" aria-hidden="true"><use xlink:href="#unorderedlist"></use></svg>
            <span>列表页面</span>
          </template>
        ...
        <!-- <el-submenu index="detail" :popper-append-to-body="false">
          <template slot="title">
            <svg class="icon-svg ra-west__menu-icon" aria-hidden="true"><use xlink:href="#detail"></use></svg>
            <span>详情页面</span>
          </template>
        ...
        <el-submenu index="error" :popper-append-to-body="false">
          <template slot="title">
            <svg class="icon-svg ra-west__menu-icon" aria-hidden="true"><use xlink:href="#error"></use></svg>
            <span>异常页面</span>
          </template>
