(function () {
  ...
  t.login.demo = 'Demo'
  t.login.copyright = 'Rubik Admin'

  t.home = {}
  t.home.sysInfo = {}
  t.home.sysInfo.name = 'System Name'
  t.home.sysInfo.nameVal = 'rubik-admin [Enterprise]'
  ...
  t.oss.aliyunDomainTips = 'Alibaba Cloud bound domain name, such as: https://fangxinqu.com/rubik-admin/'
  ...
  t.oss.localDomainTips = 'Binded domain name, eg https://fangxinqu.com/rubik-admin/'
  t.oss.fastdfsDomain = 'Domain Name'
  t.oss.fastdfsDomainTips = 'Binded domain name, eg https://fangxinqu.com/rubik-admin/'
